...
const TodoFilters = ({ setFilter , setColorFilter }) => {
  return (
    <div className="flex flex-col items-center gap-6 mt-6">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <div className="flex items-center space-x-2">
          <input type="checkbox" className="h-4 w-4 text-purple-600 focus:ring-2 focus:ring-purple-500"  onClick={()=>setColorFilter("Purple")}/>
          <label className="text-purple-800">Purple</label>
        </div>
        <div className="flex items-center space-x-2">
          <input   type="checkbox" className="h-4 w-4 text-red-600 focus:ring-2 focus:ring-red-500" onClick={()=> setColorFilter("Red")} />
          <label className="text-red-800">Red</label>
        </div>
        <div className="flex items-center space-x-2">
          <input type="checkbox" className="h-4 w-4 text-green-600 focus:ring-2 focus:ring-green-500"  onClick={()=>setColorFilter("Green")} />
          <label className="text-green-800">Green</label>
        </div>
        <div className="flex items-center space-x-2">
          <input type="checkbox" className="h-4 w-4 text-blue-600 focus:ring-2 focus:ring-blue-500"  onClick={()=>setColorFilter("Blue")} />
